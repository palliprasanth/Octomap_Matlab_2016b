iteration = 1;
data_file_pose = strcat(['data/' 'scan_00' num2str(iteration) '_robotPoses.dat']) ;
data_file_points = strcat(['data/' 'scan_00' num2str(iteration) '_points.dat']) ;
data_file_far = strcat(['data/' 'scan_00' num2str(iteration) '_farRanges.dat']) ;
